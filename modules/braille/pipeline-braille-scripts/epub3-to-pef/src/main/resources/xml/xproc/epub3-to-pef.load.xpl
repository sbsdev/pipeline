...
<p:declare-step type="px:epub3-to-pef.load" version="1.0"
    ...
    <p:choose>
        <p:when test="ends-with(lower-case($epub),'.epub')">
            <px:message message="[progress px:epub3-to-pef.load 90 px:unzip-fileset] EPUB is in a ZIP container; unzipping"/>
        ...
        <p:otherwise>
            <px:message message="[progress px:epub3-to-pef.load 90 px:fileset-create] EPUB is not in a container"/>
            <px:fileset-create>
    ...
    <px:message message="[progress px:epub3-to-pef.load 10 opf-manifest-to-fileset.xsl]"/>
    <p:xslt>
