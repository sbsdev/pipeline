...
class SearchInfo implements Cloneable {
	...
	void setPageDetails(PageDetails value) {
		...
		// System.err.println(this+".setPageDetails( "+value+" )");
		...
		if (!value.equals(old)) {
			...
			// System.err.println("[DIRTY] "+this+".setPageDetails( "+value+" != "+old+" )");
	...
	void setVolumeScope(int volumeNumber, int fromIndex, int toIndex, DocumentSpace space) {
		...
		// System.err.println(this+".setVolumeScope( "+volumeNumber+", "+fromIndex+", "+toIndex+", "+space+" )");
	...
	public SearchInfo clone() {
		...
		// System.err.println(this+".clone() -> "+clone);
