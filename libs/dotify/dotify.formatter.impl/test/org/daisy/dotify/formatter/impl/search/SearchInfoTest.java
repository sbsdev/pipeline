...
public class SearchInfoTest {
	...
	public void testSearchInfo_01() {
		...
		addPages(si, 6, 0, true, 0, 0, new DocumentSpace(Space.PRE_CONTENT, 0), null);
		addPages(si, 3, 0, true, 0, 0, DocumentSpace.BODY, 0);
		addPages(si, 3, 3, true, 0, 0, DocumentSpace.BODY, 0);
		addPages(si, 6, 0, true, 0, 0, new DocumentSpace(Space.POST_CONTENT, 0), null);
