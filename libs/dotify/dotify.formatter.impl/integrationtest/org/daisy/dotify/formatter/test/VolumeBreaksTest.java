...
public class VolumeBreaksTest extends AbstractFormatterEngineTest {
	...
	public void testUnevenVolumeBreak() throws LayoutEngineException, IOException, PagedMediaWriterConfigurationException {
		testPEF("resource-files/volume-break/volume-breaks-uneven-input.obfl", "resource-files/volume-break/volume-breaks-uneven-expected.pef", false);
	}

	@Test
	public void testForcedVolumeBreak() throws LayoutEngineException, IOException, PagedMediaWriterConfigurationException {
		testPEF("resource-files/volume-break/volume-breaks1-input.obfl", "resource-files/volume-break/volume-breaks1-expected.pef", false);
	}

	@Test
	public void testForcedVolumeBreak_02() throws LayoutEngineException, IOException, PagedMediaWriterConfigurationException {
		testPEF("resource-files/volume-break/volume-breaks2-input.obfl", "resource-files/volume-break/volume-breaks2-expected.pef", false);
	}

	@Test
	public void testForcedVolumeBreak_03() throws LayoutEngineException, IOException, PagedMediaWriterConfigurationException {
		testPEF("resource-files/volume-break/volume-breaks3-input.obfl", "resource-files/volume-break/volume-breaks2-expected.pef", false);
	}
	...
	public void testAdvancedVolumeBreak_02() throws LayoutEngineException, IOException, PagedMediaWriterConfigurationException {
		testPEF("resource-files/volume-break/volume-breaks-advanced2-input.obfl", "resource-files/volume-break/volume-breaks-advanced2-expected.pef", false);
	}
	...
	public void testAdvancedVolumeBreak_04() throws LayoutEngineException, IOException, PagedMediaWriterConfigurationException {
		testPEF("resource-files/volume-break/volume-breaks-advanced4-input.obfl", "resource-files/volume-break/volume-breaks-advanced4-expected.pef", false);
	}

	@Test
	public void testVolumeKeepPriority() throws LayoutEngineException, IOException, PagedMediaWriterConfigurationException {
		testPEF("resource-files/volume-break/volume-breaks-priority-input.obfl", "resource-files/volume-break/volume-breaks-priority-expected.pef", false);
	}

	@Test
	public void testVolumeKeepPriority_2() throws LayoutEngineException, IOException, PagedMediaWriterConfigurationException {
		testPEF("resource-files/volume-break/volume-breaks-priority2-input.obfl", "resource-files/volume-break/volume-breaks-priority2-expected.pef", false);
	}

	@Test
	public void testVolumeKeepNext() throws LayoutEngineException, IOException, PagedMediaWriterConfigurationException {
		testPEF("resource-files/volume-break/volume-breaks-keep-next-input.obfl", "resource-files/volume-break/volume-breaks-keep-next-expected.pef", false);
	}

	@Test @Ignore
	public void testKeeVolumeKeepPrevious() throws LayoutEngineException, IOException, PagedMediaWriterConfigurationException {
		testPEF("resource-files/volume-break/volume-breaks-keep-previous-input.obfl", "resource-files/volume-break/volume-breaks-keep-previous-expected.pef", false);
	}
